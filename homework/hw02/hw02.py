...
def pingpong(n):
    ...
    def helper(ind, val, dir):
        if ind == n:
            return val
        elif ind % 8 == 0 or num_eights(ind):
...
def missing_digits(n):
    ...
    if n < 10:
        ...
        return last - second_last + missing_digits(n//10)
    else:
...
def count_coins(total):
    ...
    def helper(n, coin):
        if coin == n:
            ...
            with_coin = helper(n-coin, coin)
            without_coin = helper(n, next_largest_coin(coin))
